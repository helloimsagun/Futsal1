        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    ...
                    <?php
                    // Assuming you have the current user's ID stored in $currentUserId

                    // Count pending bookings
                    $sqlPending = "SELECT COUNT(*) AS pendingCount FROM booking WHERE status = 'Pending'";
                    $resultPending = mysqli_query($con, $sqlPending);
                    $rowPending = mysqli_fetch_assoc($resultPending);
                    $pendingCount = $rowPending['pendingCount'];

                    // Count completed bookings
                    $sqlCompleted = "SELECT COUNT(*) AS completedCount FROM booking WHERE status = 'Completed'";
