...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    ...
                    <div class="row d-flex flex-grow-1 justify-content-center align-items-center mt-2">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="Username" name="Username" placeholder="Enter Username" value="<?php echo $userDetails['username']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="password" name="password" placeholder="Password" value="<?php echo $userDetails['password']; ?>">
                                    </div>
                                </div>
                                <script>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; <?php date("Y") ?> Nischal & Sagun.</strong>
            All rights reserved.
        </footer>
